...
public class SelectController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            RaycastHit[] hits = Physics.BoxCastAll(_cubeSelection.transform.GetChild(0).transform.position, _cubeSelection.transform.localScale/2, Vector3.up, Quaternion.identity, 0,layerMask);
